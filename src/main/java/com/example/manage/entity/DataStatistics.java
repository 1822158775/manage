...
public class DataStatistics implements Serializable {
    public Integer todayDayActivation;//本日批核已激活
    public Integer todayDayApproved;//本日批核未激活
    public Integer todayDayArtificial;//本日转人工
    public Integer todayDayRefuse;//本日拒绝
    public Integer todayDayAll;//本日所有数据

    public Integer todayWeekActivation;//本周已激活
    public Integer todayWeekApproved;//本周未激活
    public Integer todayWeekArtificial;//本周转人工
    public Integer todayWeekRefuse;//本周拒绝
    public Integer todayWeekAll;//本周所有数据

    public Integer todayMonthActivation;//本月激活已激活
    public Integer todayMonthApproved;//本月批核未激活
    public Integer todayMonthArtificial;//本月转人工
    public Integer todayMonthRefuse;//本月拒绝
    public Integer todayMonthAll;//本月所有数据

    public Integer todayYesterActivation;//昨日批核已激活
    public Integer todayYesterApproved;//昨日批核未激活
    ...
    public Integer lastWeekApproved;//上周批核未激活
    ...
    public Integer lastMonthApproved;//上月批核未激活
    public Integer lastMonthArtificial;//上月转人工
    public Integer lastMonthRefuse;//上月拒绝
    public Integer lastMonthAll;//上月所有数据

    public Integer todayDayActivationGrowthRate;//本日批核已激活上升率
    public Integer todayDayApprovedGrowthRate;//本日批核未激活上升率
    ...
    public Integer todayWeekActivationGrowthRate;//上月批核已激活上升率
    public Integer todayWeekApprovedGrowthRate;//上月批核未激活上升率
    ...
    public Integer todayMonthActivationGrowthRate;//上月批核已激活数据上升率
    public Integer todayMonthApprovedGrowthRate;//上月批核未激活上升率
