...
/**
 * @avthor 潘小章
 * @date 2023-06-26 15:54:21
 * 出差审核表
 */

@Data
@ToString
@TableName(value = "go_out_to_work_reimbursement")
public class GoOutToWorkReimbursement implements Serializable {
    ...
    public GoOutToWorkReimbursement() {
    }

    public GoOutToWorkReimbursement(Integer id, Integer personnelId, String verifierRemark, String reissueState) {
        this.id = id;
    ...
    public GoOutToWorkReimbursement(Integer id, Integer personnelId, String verifierRemark, String verifierTime, String reissueCode, String reissueState, Integer number) {
        this.id = id;
        this.personnelId = personnelId;
        this.verifierRemark = verifierRemark;
