...
public class HttpUtil {
     ...
     * 发送请求
     *
     * @param uri    eg:http://58.247.0.18:29015/v2/poslink/transaction/pay
     ...
     * @throws Exception
     */
    public static String send(String uri, String entity , String authorization) {
        try {
